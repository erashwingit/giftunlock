...
function Field({ label, field, placeholder, type = "text", icon: Icon, form, set }:
  ...
  return (
    <div>
      ...
      <div className="relative">
        <div className="absolute left-3 top-1/2 -translate-y-1/2"><Icon size={15} style={{ color: "#4A4A58" }} /></div>
...
export default function OrderPage() {
  ...
  const validate = (): string | null => {
    switch (step) {
      ...
      case 4: return null;
      case 5: {
        const req = [form.customerName, form.customerPhone, form.addressLine1, form.city, form.state, form.pincode];
        return req.some(v => !v.trim()) ? "Please fill all shipping fields." : null;
      }
      default: return null;
    }
  };
